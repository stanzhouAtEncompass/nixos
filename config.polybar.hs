...
--    setWMName "LG3D"
--    spawnOnce "/usr/bin/emacs --with-profile spacemacs --daemon &"
--    spawnOnce "/usr/bin/emacs --with-profile doom --daemon &"
--    spawnOnce "xscreensaver --nosplash"
--    spawnOnce "synergy &"
--  spawn "xsetroot -cursor_name left_ptr"
  setWMName "LG3D"
--  spawnOnce "/usr/bin/emacs --with-profile default --daemon &"
--  spawnOnce "/usr/bin/emacs --with-profile doom --daemon &"
  spawnOnce "xscreensaver -no-splash"
  spawnOnce "variety"
  spawnOnce "volumeicon"
  spawnOnce "unclutter -idle 10"
  spawnOnce "flameshot"
  spawnOnce "xfce.xfce4-power-manager"
  spawnOnce "xfce.xfce4-notifyd"
  spawnOnce "nm-tray"
  ...
  spawnOnce "compton -b"
  spawnOnce "clipit"
--  spawnOnce "trayer --edge top --align right --widthtype percent --height 24 --alpha 0 --transparent true --width 5 --tint 0x282c34 --monitor primary"
...
myWorkspaces    = ["Work","Personal","terminal","4.\62011","doc","6.\61884","7.\61848","\61502","9","10"]
...
myManageHook = composeAll . concat $
    ...
    myTFloats = ["Downloads", "Save As...", "clipit"]
    myRFloats = []
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask .|. shiftMask , xK_Return ), spawn $ "dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn 'NotoMonoRegular:bold:pixelsize=16'")
  ...
  , ((controlMask .|. mod1Mask , xK_j ), spawn $ "xfce4-clipman-history")
